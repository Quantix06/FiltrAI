...
audio from the active tab is captured ( after you allowed it)
speech transcribed
check-worthy, factual claims are extracted
claims evaluated against authoritative sources
verdicts, explanations are displayed to the user
what's check-worthy??
